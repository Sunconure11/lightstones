...
public class LightstonesSounds {
    ...
    public static final Identifier MUSIC_DISC_CREEPS_ID = Lightstones.id("music_disc.creeps");
    ...
    public static SoundEvent MUSIC_DISC_CREEPS = new SoundEvent(MUSIC_DISC_CREEPS_ID);
    ...
    public static void init() {
        ...
        Registry.register(Registry.SOUND_EVENT, LightstonesSounds.MUSIC_DISC_CREEPS_ID, MUSIC_DISC_CREEPS);
    }
